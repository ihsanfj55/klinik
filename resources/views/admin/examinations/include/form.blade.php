...
<div class="col-md-6">
    ...
    <input type="date" class="form-control @error('examination_date') is-invalid @enderror" name="examination_date"
        value="{{ isset($examination) ? $examination->examination_date : old('examination_date') }}">
